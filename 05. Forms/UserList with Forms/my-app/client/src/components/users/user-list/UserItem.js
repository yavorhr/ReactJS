...
export const UserItem = ({
    ...
    let blankUrl = "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460__340.png";

    return (
        <tr>
            <td>
                <img src={user.imageUrl ? user.imageUrl : blankUrl}
            ...
            <td className="actions">
                <button className="btn edit-btn" title="Edit"
                    onClick={() => actionClickHandler(user._id, UserActions.Edit)}>
                ...
                <button className="btn delete-btn" title="Delete" onClick={() => actionClickHandler(user._id, UserActions.Delete)}>
                ...
                <button onClick={() => actionClickHandler(user._id, UserActions.Details)}
                    className="btn info-btn" title="Info">
